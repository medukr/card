    ...
    <div class="card">
        ...
        <div class="card-body">
          ...
          <ul>
            ...
            <li>Proven analytical and communication skills (verbal and written)</li>
            <li>Ability to learn new technologies and challenging concepts quickly and implement them</li>
